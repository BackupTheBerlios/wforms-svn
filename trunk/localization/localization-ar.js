...
// Arab v1.00  - April 19th 2007.
// Thanks to Ameer Alshamali
...
// <script type="text/javascript" src="localization-ar.js" ></script>
// </head>

wFORMS.behaviors['validation'].errMsg_required = "	هذه الخانة مطلوبة."; // required
wFORMS.behaviors['validation'].errMsg_alpha  = "نرجوا إدخال حروف فقط (أ-ي) الأرقام غير مسموحة."; // no numbers 
wFORMS.behaviors['validation'].errMsg_email = "عنوان بريد إلكتروني غير صحيح."; // validate email 
wFORMS.behaviors['validation'].errMsg_integer = "نرجوا إدخال أرقام فقط."; // integer 
wFORMS.behaviors['validation'].errMsg_float = "نرجوا إدخال رقم عشري"; // float 
wFORMS.behaviors['validation'].errMsg_password = ""; // password
wFORMS.behaviors['validation'].errMsg_alphanum = "نرجوا كتابة حروف وأرقام (أ-ي) و(0-9) فقط."; // alphanumeric
wFORMS.behaviors['validation'].errMsg_date = "التاريخ غير صحيح."; // date
wFORMS.behaviors['validation'].errMsg_notification = "تم التعرف على %% خطأ. نرجوا التأكد من صحة معلوماتك."; // %% errors.

wf.arrMsg[0] = "أضف رد أخر"; // repeat row
wf.arrMsg[1] = "" // repeat row title 
wf.arrMsg[2] = "حذف"; // remove row
wf.arrMsg[3] = "" // remove row title
wf.arrMsg[4] = "الصفحة التالية";
wf.arrMsg[5] = "الصفحة السابقة";
