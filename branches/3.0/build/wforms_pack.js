...
var _336=elem.matchSingle("td:nth-last-child(0n+1)");
if(_336==""){
_336=elem.appendChild(document.createElement("TD"));
}
_336.appendChild(e);
}else{
elem.appendChild(e);
...
var _338=document.createElement("a");
_338.id=id;
_338.setAttribute("href","#");
_338.className=wFORMS.behaviors.repeat.CSS_DUPLICATE_LINK;
_338.setAttribute("title",wFORMS.behaviors.repeat.MESSAGES.ADD_TITLE);
_338.appendChild(document.createElement("span").appendChild(document.createTextNode(wFORMS.behaviors.repeat.MESSAGES.ADD_CAPTION)));
return _338;
};
wFORMS.behaviors.repeat.createRemoveLink=function(id){
var _33a=document.createElement("a");
_33a.id=id+wFORMS.behaviors.repeat.ID_SUFFIX_DUPLICATE_LINK;
_33a.setAttribute("href","#");
_33a.className=wFORMS.behaviors.repeat.CSS_DELETE_LINK;
_33a.setAttribute("title",wFORMS.behaviors.repeat.MESSAGES.REMOVE_TITLE);
_33a.setAttribute(wFORMS.behaviors.repeat.ATTR_LINK_SECTION_ID,id);
var _33b=document.createElement("span");
_33b.appendChild(document.createTextNode(wFORMS.behaviors.repeat.MESSAGES.REMOVE_CAPTION));
_33a.appendChild(_33b);
_33a.onclick=function(_33c){
wFORMS.behaviors.repeat.onRemoveLinkClick(_33c,_33a);
};
return _33a;
};
...
var _33f=base2.DOM.bind(elem.cloneNode(true));
var _340=elem;
while(_340&&(_340.nodeType==3||_340.hasClass(wFORMS.behaviors.repeat.CSS_REMOVEABLE)||_340.hasClass(wFORMS.behaviors.repeat.CSS_REPEATABLE))){
_340=_340.nextSibling;
if(_340&&_340.nodeType==1&&!_340.hasClass){
_340=base2.DOM.bind(_340);
}
}
elem.parentNode.insertBefore(_33f,_340);
this.updateDuplicatedSection(_33f);
wFORMS.applyBehaviors(_33f);
wFORMS.behaviors.repeat.onRepeat(_33f);
};
...
wFORMS.behaviors.repeat.onRemoveLinkClick=function(_343,elem){
...
var _346=this.createSuffix(elem);
elem.id=this.clearSuffix(elem.id)+_346;
this.updateMasterElements(elem,_346);
};
wFORMS.behaviors.repeat.instance.prototype.updateMasterElements=function(elem,_348){
...
var _34d=wFORMS.behaviors.repeat.UPDATEABLE_ATTR_ARRAY[j];
var _34e=this.clearSuffix(n.getAttribute(_34d));
if(!_34e){
continue;
}
if(wFORMS.behaviors.hint&&wFORMS.behaviors.hint.isHintId(n.id)){
n.setAttribute(_34d,_34e.replace(new RegExp("(.*)("+wFORMS.behaviors.hint.HINT_SUFFIX+")$"),"$1"+_348+"$2"));
}else{
if(n.id.indexOf(wFORMS.behaviors.repeat.ID_SUFFIX_DUPLICATE_LINK)!=-1){
n.setAttribute(_34d,_34e.replace(new RegExp("(.*)("+wFORMS.behaviors.repeat.ID_SUFFIX_DUPLICATE_LINK+")$"),"$1"+_348+"$2"));
}else{
n.setAttribute(_34d,_34e+_348);
}
}
}
this.updateMasterElements(n,_348);
}
}
};
wFORMS.behaviors.repeat.instance.prototype.updateDuplicatedSection=function(elem){
var _350=this;
var _351=this.getNextDuplicateIndex(this.target);
var _352=this.createSuffix(elem,_351);
elem.setAttribute(wFORMS.behaviors.repeat.ATTR_MASTER_SECTION,elem.id);
elem.id=this.clearSuffix(elem.id)+_352;
...
var _353=wFORMS.behaviors.repeat.preserveRadioName;
}
this.updateSectionChildNodes(elem.matchAll("> *"),_352,_353);
};
wFORMS.behaviors.repeat.instance.prototype.updateSectionChildNodes=function(_354,_355,_356){
var _357=this;
_354.forEach(function(e){
...
var _359=e.tagName.toUpperCase();
if(_359=="INPUT"||_359=="TEXTAREA"){
...
_357.updateAttributes(e,_355,_356);
if(_elems=e.matchAll("> *")){
if(e.hasClass(wFORMS.behaviors.repeat.CSS_REPEATABLE)){
_357.updateSectionChildNodes(_elems,wFORMS.behaviors.repeat.instance.prototype.createSuffix(e),_356);
}else{
_357.updateSectionChildNodes(_elems,_355,_356);
}
}
});
};
wFORMS.behaviors.repeat.instance.prototype.createSuffix=function(e,_35b){
var _35c="["+(_35b?_35b:"0")+"]";
var reg=/\[(\d+)\]$/;
e=e.parentNode;
while(e){
...
wFORMS.behaviors.repeat.instance.prototype.clearSuffix=function(_35f){
if(!_35f){
return;
}
if(_35f.indexOf("[")!=-1){
return _35f.substring(0,_35f.indexOf("["));
}
return _35f;
};
wFORMS.behaviors.repeat.instance.prototype.updateAttributes=function(e,_361,_362){
var _363=wFORMS.behaviors.hint&&wFORMS.behaviors.hint.isHintId(e.id);
var _364=e.id.indexOf(wFORMS.behaviors.repeat.ID_SUFFIX_DUPLICATE_LINK)!=-1;
...
var _366=wFORMS.behaviors.repeat.UPDATEABLE_ATTR_ARRAY[i];
var _367=this.clearSuffix(e.getAttribute(_366));
if(!_367){
continue;
}
if(_366=="name"&&e.tagName.toUpperCase()=="INPUT"&&_362){
continue;
}
if(_363&&_366=="id"){
e.setAttribute("id",_367+_361+wFORMS.behaviors.hint.HINT_SUFFIX);
}else{
if(_364){
e.setAttribute(_366,_367.replace(new RegExp("(.*)("+wFORMS.behaviors.repeat.ID_SUFFIX_DUPLICATE_LINK+")$"),"$1"+_361+"$2"));
}else{
e.setAttribute(_366,_367+_361);
}
}
}
};
...
var _36a=parseInt(c.value)+1;
c.value=_36a;
return _36a;
};
wFORMS.behaviors.repeat.getOrCreateCounterField=function(elem){
var cId=elem.id+wFORMS.behaviors.repeat.ID_SUFFIX_COUNTER;
var _36d=document.getElementById(cId);
if(!_36d||_36d==""){
_36d=wFORMS.behaviors.repeat.createCounterField(cId);
var _36e=elem.parentNode;
while(_36e&&_36e.tagName.toUpperCase()!="FORM"){
_36e=_36e.parentNode;
}
_36e.appendChild(_36d);
}
return _36d;
};
...
wFORMS.behaviors.repeat.instance.prototype.run=function(e,_37c){
...
case "OPTION":
var _384=elem.parentNode;
while(_384&&_384.tagName.toUpperCase()!="SELECT"){
_384=_384.parentNode;
}
base2.DOM.bind(_384);
if(_384&&!wFORMS.behaviors["switch"].isHandled(_384)){
_384.addEventListener("change",function(_385){
b.run(_385,_384);
},false);
b.setupTargets(elem);
wFORMS.behaviors["switch"].handleElement(_384);
}
break;
case "INPUT":
...
var _386=elem.form[elem.name];
for(var i=_386.length-1;i>=0;i--){
var _388=base2.DOM.bind(_386[i]);
if(!wFORMS.behaviors["switch"].isHandled(_388)){
_388.addEventListener("click",function(_389){
b.run(_389,_388);
},false);
wFORMS.behaviors["switch"].handleElement(_388);
}
}
}else{
elem.addEventListener("click",function(_38a){
b.run(_38a,elem);
},false);
b.setupTargets(elem);
}
...
wFORMS.behaviors["switch"].instance.prototype.getTriggersByElements=function(_38f,_390){
...
case "OPTION":
if(elem.selected){
o.ON=o.ON.concat(this.behavior.getSwitchNamesFromTrigger(elem,_390));
}else{
o.OFF=o.OFF.concat(this.behavior.getSwitchNamesFromTrigger(elem,_390));
}
break;
case "SELECT":
...
if(opt.selected){
o.ON=o.ON.concat(this.behavior.getSwitchNamesFromTrigger(opt,_390));
}else{
o.OFF=o.OFF.concat(this.behavior.getSwitchNamesFromTrigger(opt,_390));
}
}
break;
case "INPUT":
if(elem.type&&elem.type.toUpperCase()=="RADIO"){
var _396=elem.form[elem.name];
for(var j=_396.length-1;j>=0;j--){
var _397=_396[j];
if(_397==elem||!base2.Array2.contains(_38f,_397)){
if(_397.checked){
o.ON=o.ON.concat(this.behavior.getSwitchNamesFromTrigger(_397,_390));
}else{
o.OFF=o.OFF.concat(this.behavior.getSwitchNamesFromTrigger(_397,_390));
}
}
}
}else{
...
wFORMS.behaviors["switch"].getSwitchNamesFromTrigger=function(elem,_39b){
return wFORMS.behaviors["switch"].getSwitchNames(elem.className,"trigger",_39b);
};
wFORMS.behaviors["switch"].getSwitchNamesFromTarget=function(elem,_39d){
return wFORMS.behaviors["switch"].getSwitchNames(elem.className,"target",_39d);
};
wFORMS.behaviors["switch"].getSwitchNames=function(_39e,_39f,_3a0){
if(!_39e||_39e==""){
return [];
}
var _3a1=_39e.split(" ");
...
if(sn&&(!_3a0||base2.Array2.contains(_3a0,sn))){
_3a2.push(sn);
}
}
return _3a2;
};
wFORMS.behaviors["switch"].instance.prototype.getTargetsBySwitchName=function(_3a7,_3a8){
var res=new Array();
var _3aa=this;
var b=wFORMS.behaviors.repeat;
if(arguments[1]=="ON"){
var _3ac=[wFORMS.behaviors["switch"].CSS_ONSTATE_PREFIX+_3a7];
}else{
var _3ac=[wFORMS.behaviors["switch"].CSS_OFFSTATE_PREFIX+_3a7];
}
this.target.getElementsByClassName(_3ac).forEach(function(elem){
if(b&&b.isInDuplicateGroup(elem)&&!(b.isDuplicate(_3aa.target)||b.isInDuplicateGroup(_3aa.target))){
return;
}
...
wFORMS.behaviors["switch"].instance.prototype.getTriggersByTarget=function(_3ae){
var res=new Array();
var _3b0=this;
var _3b1=wFORMS.behaviors["switch"].getSwitchNamesFromTarget(_3ae);
var b=wFORMS.behaviors.repeat;
base2.forEach(_3b1,function(name){
_3b0.target.getElementsByClassName([wFORMS.behaviors["switch"].CSS_PREFIX+name]).forEach(function(elem){
if(b&&b.isInDuplicateGroup(elem)&&!(b.isDuplicate(_3ae)||b.isInDuplicateGroup(_3ae))){
return;
}
res.push(base2.DOM.bind(elem));
});
});
return this.getTriggersByElements(res,_3b1);
};
...
wFORMS.behaviors["switch"].instance.prototype.run=function(e,_3b8){
if(!_3b8.hasClass){
base2.DOM.bind(_3b8);
}
if(_3b8.hasClass(this.behavior.CSS_ONSTATE_FLAG)){
_3b8.removeClass(this.behavior.CSS_ONSTATE_FLAG);
_3b8.addClass(this.behavior.CSS_OFFSTATE_FLAG);
if(e){
e.preventDefault();
}
}else{
if(_3b8.hasClass(this.behavior.CSS_OFFSTATE_FLAG)){
_3b8.removeClass(this.behavior.CSS_OFFSTATE_FLAG);
_3b8.addClass(this.behavior.CSS_ONSTATE_FLAG);
if(e){
e.preventDefault();
}
}
}
var _3b9=this.getTriggersByElements(new Array(_3b8));
var _3ba=this;
base2.forEach(_3b9.OFF,function(_3bb){
var _3bc=_3ba.getTargetsBySwitchName(_3bb,"ON");
base2.forEach(_3bc,function(elem){
var _3be=_3ba.getTriggersByTarget(elem);
if(_3be.ON.length==0){
elem.addClass(wFORMS.behaviors["switch"].CSS_OFFSTATE_PREFIX+_3bb);
elem.removeClass(wFORMS.behaviors["switch"].CSS_ONSTATE_PREFIX+_3bb);
_3ba.behavior.onSwitchOff(elem);
}
});
});
base2.forEach(_3b9.ON,function(_3bf){
var _3c0=_3ba.getTargetsBySwitchName(_3bf,"OFF");
base2.forEach(_3c0,function(elem){
elem.removeClass(wFORMS.behaviors["switch"].CSS_OFFSTATE_PREFIX+_3bf);
elem.addClass(wFORMS.behaviors["switch"].CSS_ONSTATE_PREFIX+_3bf);
_3ba.behavior.onSwitchOn(elem);
});
});
...
wFORMS.behaviors.validation.instance.prototype.run=function(e,_3cb){
var _3cc=0;
this.elementsInError={};
for(var _3cd in this.behavior.rules){
var rule=this.behavior.rules[_3cd];
var _3cf=this;
if(!_3cb.matchAll){
base2.DOM.bind(_3cb);
}
_3cb.matchAll(rule.selector).forEach(function(_3d0){
if(_3cf.isSwitchedOff(_3d0)){
return;
}
var _3d1=wFORMS.helpers.getFieldValue(_3d0);
if(rule.check.call){
var _3d2=rule.check.call(_3cf,_3d0,_3d1);
}else{
var _3d2=_3cf[rule.check].call(_3cf,_3d0,_3d1);
}
if(!_3d2){
if(!_3d0.id){
_3d0.id=wFORMS.helpers.randomId();
}
_3cf.elementsInError[_3d0.id]={id:_3d0.id,rule:_3cd};
_3cf.removeErrorMessage(_3d0);
if(rule.fail){
rule.fail.call(_3cf,_3d0,_3cd);
}else{
_3cf.fail.call(_3cf,_3d0,_3cd);
}
_3cc++;
}else{
if(!_3cf.elementsInError[_3d0.id]){
_3cf.removeErrorMessage(_3d0);
}
if(rule.pass){
rule.pass.call(_3cf,_3d0);
}else{
_3cf.pass.call(_3cf,_3d0);
}
}
});
}
...
wFORMS.behaviors.validation.instance.prototype.fail=function(_3d3,_3d4){
_3d3.addClass(this.behavior.styling.fieldError);
this.addErrorMessage(_3d3,this.behavior.messages[_3d4]);
},wFORMS.behaviors.validation.instance.prototype.pass=function(_3d5){
};
wFORMS.behaviors.validation.instance.prototype.addErrorMessage=function(_3d6,_3d7){
if(!_3d6.id){
_3d6.id=wFORMS.helpers.randomId();
}
var _3d8=document.createTextNode(" "+_3d7);
var p=document.getElementById(_3d6.id+"-E");
if(!p){
p=document.createElement("div");
p.setAttribute("id",_3d6.id+"-E");
p=_3d6.parentNode.insertBefore(p,_3d6.nextSibling);
}
p.appendChild(_3d8);
base2.DOM.bind(p);
p.addClass(this.behavior.styling.errorMessage);
};
wFORMS.behaviors.validation.instance.prototype.removeErrorMessage=function(_3da){
if(!_3da.hasClass){
base2.DOM.bind(_3da);
}
if(_3da.hasClass(this.behavior.styling.fieldError)){
_3da.removeClass(this.behavior.styling.fieldError);
var _3db=document.getElementById(_3da.id+"-E");
if(_3db){
_3db.parentNode.removeChild(_3db);
}
}
};
wFORMS.behaviors.validation.instance.prototype.isSwitchedOff=function(_3dc){
var sb=wFORMS.getBehaviorInstance(this.target,"switch");
if(sb){
var _3de=_3dc;
while(_3de&&_3de.tagName!="BODY"){
if(_3de.className&&_3de.className.indexOf(sb.behavior.CSS_OFFSTATE_PREFIX)!=-1&&_3de.className.indexOf(sb.behavior.CSS_ONSTATE_PREFIX)==-1){
return true;
}
...
var _3e0=/^\s+$/;
return ((s==null)||(s.length==0)||_3e0.test(s));
};
wFORMS.behaviors.validation.instance.prototype.validateRequired=function(_3e1,_3e2){
switch(_3e1.tagName){
case "INPUT":
var _3e3=_3e1.getAttribute("type");
if(!_3e3){
_3e3="text";
}
switch(_3e3.toLowerCase()){
case "checkbox":
case "radio":
return _3e1.checked;
break;
default:
return !this.isEmpty(_3e2);
}
break;
case "SELECT":
return !this.isEmpty(_3e2);
...
break;
default:
return this.validateOneRequired(_3e1);
break;
}
return false;
};
wFORMS.behaviors.validation.instance.prototype.validateOneRequired=function(_3e4){
if(_3e4.nodeType!=1){
return false;
}
if(this.isSwitchedOff(_3e4)){
return false;
}
switch(_3e4.tagName){
case "INPUT":
var _3e5=_3e4.getAttribute("type");
if(!_3e5){
_3e5="text";
}
switch(_3e5.toLowerCase()){
case "checkbox":
case "radio":
return _3e4.checked;
break;
default:
return !this.isEmpty(wFORMS.helpers.getFieldValue(_3e4));
}
break;
case "SELECT":
return !this.isEmpty(wFORMS.helpers.getFieldValue(_3e4));
...
break;
default:
for(var i=0;i<_3e4.childNodes.length;i++){
if(this.validateOneRequired(_3e4.childNodes[i])){
return true;
}
}
break;
...
wFORMS.behaviors.validation.instance.prototype.validateAlpha=function(_3e7,_3e8){
var _3e9=/^[a-zA-Z\s]+$/;
return this.isEmpty(_3e8)||_3e9.test(_3e8);
};
wFORMS.behaviors.validation.instance.prototype.validateAlphanum=function(_3ea,_3eb){
var _3ec=/^[\w\s]+$/;
return this.isEmpty(_3eb)||_3ec.test(_3eb);
};
wFORMS.behaviors.validation.instance.prototype.validateDate=function(_3ed,_3ee){
var _3ef=new Date(_3ee);
return this.isEmpty(_3ee)||!isNaN(_3ef);
};
wFORMS.behaviors.validation.instance.prototype.validateTime=function(_3f0,_3f1){
return true;
};
wFORMS.behaviors.validation.instance.prototype.validateEmail=function(_3f2,_3f3){
var _3f4=/\w{1,}[@][\w\-]{1,}([.]([\w\-]{1,})){1,3}$/;
return this.isEmpty(_3f3)||_3f4.test(_3f3);
};
wFORMS.behaviors.validation.instance.prototype.validateInteger=function(_3f5,_3f6){
var _3f7=/^[+]?\d+$/;
return this.isEmpty(_3f6)||_3f7.test(_3f6);
};
wFORMS.behaviors.validation.instance.prototype.validateFloat=function(_3f8,_3f9){
return this.isEmpty(_3f9)||!isNaN(parseFloat(_3f9));
};
wFORMS.behaviors.validation.instance.prototype.validateCustom=function(_3fa,_3fb){
var _3fc=new RegExp("/(.*)/([gi]*)");
var _3fd=_3fa.className.match(_3fc);
if(_3fd&&_3fd[0]){
var _3fe=new RegExp(_3fd[1],_3fd[2]);
if(!_3fb.match(_3fe)){
return false;
}
}
...
var _403=elem.className.substr(elem.className.indexOf("formula=")+8).split(" ")[0];
var _404=_403.split(/[^a-zA-Z]+/g);
b.varFields=[];
for(var i=0;i<_404.length;i++){
if(_404[i]!=""){
f.matchAll("*[class*=\""+wFORMS.behaviors.calculation.VARIABLE_SELECTOR_PREFIX+_404[i]+"\"]").forEach(function(_406){
switch(_406.tagName+":"+_406.getAttribute("type")){
case "INPUT:":
case "INPUT:null":
case "INPUT:text":
case "INPUT:hidden":
case "INPUT:password":
case "TEXTAREA:null":
if(!_406._wforms_calc_handled){
_406.addEventListener("blur",function(e){
return b.run(e,this);
},false);
_406._wforms_calc_handled=true;
}
break;
case "INPUT:radio":
case "INPUT:checkbox":
if(!_406._wforms_calc_handled){
_406.addEventListener("click",function(e){
return b.run(e,this);
},false);
_406._wforms_calc_handled=true;
}
...
case "SELECT:null":
if(!_406._wforms_calc_handled){
_406.addEventListener("change",function(e){
return b.run(e,this);
},false);
_406._wforms_calc_handled=true;
}
...
b.varFields.push({name:_404[i],field:_406});
});
}
}
var calc={field:elem,formula:_403,variables:b.varFields};
b.calculations.push(calc);
b.compute(calc);
});
return b;
};
wFORMS.behaviors.calculation.instance.prototype.run=function(_40b,_40c){
for(var i=0;i<this.calculations.length;i++){
var calc=this.calculations[i];
for(var j=0;j<calc.variables.length;j++){
if(_40c==calc.variables[j].field){
this.compute(calc);
}
}
}
};
wFORMS.behaviors.calculation.instance.prototype.compute=function(_410){
var f=this.target;
var _412=_410.formula;
for(var i=0;i<_410.variables.length;i++){
var v=_410.variables[i];
var _415=0;
var _416=this;
f.matchAll("*[class*=\""+wFORMS.behaviors.calculation.VARIABLE_SELECTOR_PREFIX+v.name+"\"]").forEach(function(f){
var _418=_416.getValueFromClassName(f);
if(!_418){
_418=wFORMS.helpers.getFieldValue(f);
}
if(!_418){
_418=0;
}
if(_418.constructor.toString().indexOf("Array")!==-1){
for(var j=0;j<_418.length;j++){
_415+=parseFloat(_418[j]);
}
}else{
_415+=parseFloat(_418);
}
});
...
if(m){
if(m[1]){
_412=_412.replace(m[1],_415);
}else{
_412=_412.replace(m[0],_415);
}
}
}
try{
var _41c=eval(_412);
if(_41c=="Infinity"||_41c=="NaN"||isNaN(_41c)){
_41c="error";
}
}
catch(x){
...
var _41d=wFORMS.getBehaviorInstance(this.target,"validation");
if(_41d){
...
_41d.removeErrorMessage(_410.field);
if(_41c=="error"){
_41d.fail(_410.field,"calculation");
}
}
_410.field.value=_41c;
if(_410.field.className&&(_410.field.className.indexOf(this.behavior.VARIABLE_SELECTOR_PREFIX)!=-1)){
this.run(null,_410.field);
}
};
wFORMS.behaviors.calculation.instance.prototype.getValueFromClassName=function(_41e){
switch(_41e.tagName){
case "INPUT":
if(!_41e.className||_41e.className.indexOf(this.behavior.CHOICE_VALUE_SELECTOR_PREFIX)==-1){
return null;
}
var _41f=_41e.className.split(this.behavior.CHOICE_VALUE_SELECTOR_PREFIX)[1].split(" ")[0];
if(_41e.type=="checkbox"){
return _41e.checked?_41f:null;
}
if(_41e.type=="radio"){
return _41e.checked?_41f:null;
}
...
break;
case "SELECT":
if(_41e.selectedIndex==-1){
return null;
}
if(_41e.getAttribute("multiple")){
var v=[];
for(var i=0;i<_41e.options.length;i++){
if(_41e.options[i].selected){
if(_41e.options[i].className&&_41e.options[i].className.indexOf(this.behavior.CHOICE_VALUE_SELECTOR_PREFIX)!=-1){
var _41f=_41e.options[i].className.split(this.behavior.CHOICE_VALUE_SELECTOR_PREFIX)[1].split(" ")[0];
v.push(_41f);
}
}
}
...
if(_41e.options[_41e.selectedIndex].className&&_41e.options[_41e.selectedIndex].className.indexOf(this.behavior.CHOICE_VALUE_SELECTOR_PREFIX)!=-1){
var _41f=_41e.options[_41e.selectedIndex].className.split(this.behavior.CHOICE_VALUE_SELECTOR_PREFIX)[1].split(" ")[0];
return _41f;
}
break;
case "TEXTAREA":
